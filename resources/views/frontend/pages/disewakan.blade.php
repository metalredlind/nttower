        ...
        <div class="container">
            ...
            <div class="row properties-box">
                ...
                <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 adv">
                    <div class="item">
                        <a href="{{route('disewakan-detail')}}"><img src="{{asset($disewakan->thumb_image)}}" alt=""></a>
                        <span class="category">{{$disewakan->kategori_properti}}</span>
                        <h4><a href="{{route('disewakan-detail')}}">{{$disewakan->nama_properti}}</a></h4>
                        <ul>
                        ...
                        <div class="main-button">
                            <a href="{{route('disewakan-detail')}}">Lihat Detil</a>
                        </div>
                    </div>
                </div>
                @endforeach
